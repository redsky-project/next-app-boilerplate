...
import { TablePagination } from '@/app/(domains)/example/_components/data-table/common';
...
export function DataTableWithPagination() {
	...
	return (
		<div className="w-full space-y-4">
			<div>
				<h2 className="text-2xl font-bold tracking-tight">Pagination Example</h2>
				<p className="text-muted-foreground">Navigate through pages of data</p>
			</div>
