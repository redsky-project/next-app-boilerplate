	...
	return (
		<div className="container mx-auto space-y-12 py-10">
			...
			<div className="space-y-4">
				<h1 className="text-4xl font-bold tracking-tight">Data Table Examples</h1>
				<p className="text-lg text-muted-foreground">
					Comprehensive examples of TanStack Table with shadcn/ui. From basic usage to advanced features.
				</p>
			</div>
