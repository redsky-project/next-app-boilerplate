				...
				99
						...
						<div className="flex flex-col gap-2 pt-6">
							...
							<ul className="text-muted-foreground text-[1.05rem] text-balance sm:text-base border-l-2 border-l-neutral-200 overflow-hidden dark:border-l-neutral-800 px-2 py-0">
								<li>
									<strong>default</strong> : 기본 버튼 스타일
								</li>
								<li>
								...
								<li>
									<strong>secondary</strong> : 보조 버튼 스타일
								</li>
								<li>
								...
								<li>
									<strong>success</strong> : 상태를 나타내는 색상 (초록)
								</li>
								<li>
									<strong>warning</strong> : 상태를 나타내는 색상 (주황)
								</li>
								<li>
									<strong>info</strong> : 상태를 나타내는 색상 (파랑)
								</li>
								<li>
									<strong>purple</strong> : 추가 purple색상 옵션
								</li>
								<li>
									<strong>pink</strong> : 추가 pink 색상 옵션
								</li>
								<li>
									<strong>indigo</strong> : 추가 indigo 색상 옵션
								</li>
								<li>
									<strong>teal</strong> : 추가 teal 색상 옵션
								</li>
							</ul>
						</div>
						<div className="w-full flex-1 py-4">
	...
	return (
		...
		<Button variant="teal">teal</Button>
						...
						<div className="flex flex-col gap-2 pt-6">
							...
							<ul className="text-muted-foreground text-[1.05rem] text-balance sm:text-base border-l-2 border-l-neutral-200 overflow-hidden dark:border-l-neutral-800 px-2 py-0">
								<li>
									<strong>default</strong> : 기본 버튼 크기
								</li>
								<li>
									<strong>sm</strong> : 작은 버튼 크기
								</li>
								<li>
									<strong>lg</strong> : 큰 버튼 크기
								</li>
								<li>
									<strong>xl</strong> : 더 큰 버튼 크기
								</li>
								<li>
									<strong>2xl</strong> : 추가 더 큰 버튼 크기
								</li>
								<li>
									<strong>xs</strong> : 가장 작은 버튼 크기
								</li>
								<li>
									<strong>icon</strong> : 아이콘 버튼 크기
								</li>
								<li>
									<strong>icon-sm</strong> : 작은 아이콘 버튼 크기
								</li>
								<li>
									<strong>icon-lg</strong> : 큰 아이콘 버튼 크기
								</li>
							</ul>
						</div>
						<div className="w-full flex-1 py-4">
		...
		>
			<Icon name="Settings" />
						...
						<div className="flex flex-col gap-2 pt-6">
							...
							<p className="text-muted-foreground text-[1.05rem] text-balance sm:text-base">
								<strong>Server Component</strong>에서 <strong>Button</strong> 컴포넌트는 JavsScript의 이벤트 처리를
								하지않고 <strong>Form</strong>의 Submit 이벤트를 처리할 수 있습니다.
							</p>
						</div>
						<div className="w-full flex-1 py-4">
							<div className="w-full rounded-lg border border-neutral-200 overflow-hidden dark:border-neutral-800 px-6 py-4 shadow-sm">
