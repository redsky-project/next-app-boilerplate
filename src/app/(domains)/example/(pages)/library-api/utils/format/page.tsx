...
interface IUtilsFormatExProps {
	//test?: string;
}

export default function UtilsFormatEx({}: IUtilsFormatExProps): JSX.Element {
	return (
		<>
				...
				<div className="mx-auto flex w-full  min-w-0 flex-1 flex-col gap-8 px-4 py-6 text-neutral-800 md:px-0 lg:py-8 dark:text-neutral-300">
					<div className="flex flex-col gap-2">
						<div className="flex items-start justify-between">
							<h1 className="scroll-m-20 text-4xl font-semibold tracking-tight sm:text-3xl xl:text-4xl">$utils.format</h1>
						...
						<p className="text-muted-foreground text-[1.05rem] text-balance sm:text-base">
							<strong>$utils.format.*</strong> 함수는 <strong>Server Component, Client Component</strong> 모두 사용할 수 있습니다. 상황에 맞게 사용하면 됩니다.
						</p>
					</div>
